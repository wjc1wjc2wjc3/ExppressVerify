...
+ (void) showLoadingInView {
    UIView *view = nil;
    ExpressActivityIndicatorView *indicatorView = [ExpressActivityIndicatorView defaultIndicator];
    dispatch_async(dispatch_get_main_queue(), ^{
        prestrainView = view;
...
+ (void) stopLoadingView {
    ...
    for (UIView *view in subViews) {
        if ([view isKindOfClass:[ExpressActivityIndicatorView class]]) {
            ExpressActivityIndicatorView *indicatorView = (ExpressActivityIndicatorView *)view;
