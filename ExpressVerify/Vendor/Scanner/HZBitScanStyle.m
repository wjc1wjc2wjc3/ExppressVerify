...
+ (LBXScanViewStyle*)ZhiFuBaoStyle
{
    ...
    UIImage *imgFullNet = [UIImage imageNamed:@"Frameworks/LBXScan.framework/CodeScan.bundle/qrcode_scan_full_net"];
...
+ (LBXScanViewStyle*)InnerStyle
{
    ...
    //qq里面的线条图片
    UIImage *imgLine = [UIImage imageNamed:@"Frameworks/LBXScan.framework/CodeScan.bundle/qrcode_scan_light_green"];
...
+ (LBXScanViewStyle*)weixinStyle
{
    ...
    //qq里面的线条图片
    UIImage *imgLine = [UIImage imageNamed:@"Frameworks/LBXScan.framework/CodeScan.bundle/qrcode_Scan_weixin_Line"];
    style.animationImage = imgLine;
...
+ (LBXScanViewStyle*)recoCropRect
{
    ...
    //使用的支付宝里面网格图片
    UIImage *imgPartNet = [UIImage imageNamed:@"Frameworks/LBXScan.framework/CodeScan.bundle/qrcode_scan_part_net"];
...
+ (LBXScanViewStyle*)changeColor
{
    ...
    style.animationImage = [UIImage imageNamed:@"Frameworks/LBXScan.framework/CodeScan.bundle/qrcode_scan_part_net"];;
    //码框周围4个角的颜色
